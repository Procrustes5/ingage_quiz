    ...
    <div className="flex flex-col min-h-screen bg-background">
      <header className="flex items-center justify-between px-8 py-4 border-b">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Trivia Blitz</h1>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-8 py-16">
        <div className="max-w-3xl w-full bg-card rounded-lg shadow-lg overflow-hidden">
          <div className="bg-[url('/geometric-pattern.svg')] bg-cover bg-center bg-no-repeat p-8">
            <h2 className="text-4xl font-bold text-foreground mb-4">What is the capital of Australia?</h2>
          </div>
        </div>
      </main>
