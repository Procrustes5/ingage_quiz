    ...
    <div className="flex flex-col h-screen">
      ...
      <main className="flex-1 p-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Manage your quiz rooms and create new ones from here.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-background rounded-lg shadow-md p-6">
            ...
            <p className="text-muted-foreground mb-6">View, edit, and delete your existing quiz rooms.</p>
